...
import { Layers, Users, Store, LogOut, ChevronRight, MessageSquare } from 'lucide-react'
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col glass-card rounded-[2rem] overflow-hidden">
        ...
        <a href="mailto:rummanakhtar10@gmail.com?subject=Relore App Feedback" className="flex items-center justify-between p-5 border-b border-white/40 hover:bg-white/40 active:bg-white/60 transition-colors touch-scale">
          <div className="flex items-center gap-4">
